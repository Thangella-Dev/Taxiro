...
drop policy if exists "authenticated read active service areas" on public.service_areas;
drop policy if exists "admins manage service areas" on public.service_areas;
drop policy if exists "authenticated read active pricing" on public.pricing_rules;
...
drop policy if exists "profiles manage saved places" on public.saved_places;
drop policy if exists "ride participants read stops" on public.ride_stops;
drop policy if exists "ride owners manage stops" on public.ride_stops;
drop policy if exists "profiles manage recurring rides" on public.recurring_ride_templates;
drop policy if exists "owners manage trip shares" on public.trip_shares;
drop policy if exists "authenticated read active promos" on public.promo_codes;
drop policy if exists "admins manage promos" on public.promo_codes;
drop policy if exists "profiles read promo redemptions" on public.promo_redemptions;
drop policy if exists "profiles read wallets" on public.wallets;
drop policy if exists "profiles read wallet transactions" on public.wallet_transactions;
drop policy if exists "riders read own incentives" on public.rider_incentives;
drop policy if exists "admins manage incentives" on public.rider_incentives;
drop policy if exists "business owners read account" on public.business_accounts;
drop policy if exists "business owners manage account" on public.business_accounts;
drop policy if exists "business members read membership" on public.business_account_members;
